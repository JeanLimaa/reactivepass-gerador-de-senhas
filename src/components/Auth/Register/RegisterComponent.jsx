        ...
        {({ values }) => (
          ...
          >
            ...
            <div className="flex relative justify-end items-center">
              ...
              <div className="absolute pr-4 w-15 pt-3">
                <Image src={showPass ? "/show-black.svg" : "/hide-black.svg"} title="Visualizar senha" alt="Visualizar senha" className="cursor-pointer"
                  onClick={() => setShowPass(!showPass)} layout="responsive" width={100} height={100} />
              </div>
            </div>
